const myContractABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bool", name: "approve_", type: "bool" },
    ],
    name: "OwnerApproval",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [{ internalType: "address", name: "_opr", type: "address" }],
    name: "setOperator",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
